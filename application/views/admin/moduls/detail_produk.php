...
<?php $key = $this->uri->segment(3);?><!-- segment untuk link (http://localhost/dapurjogja/gallery/gallery_detail/1)-->
...
<script>
	...
	function edit(id) {
			...
			$.ajax({
				...
				$('[name="detail_deskripsi"]').val(result.detail_deskripsi);
				...
				// $('[name="detail_deskripsi_meta"]').val(result.detail_deskripsi_meta);
