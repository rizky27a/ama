...
<?php $title = "<i class='fa fa-file-image-o'></i>&nbsp;Karya"; ?>
...
<div class="widget-box">
<div class="widget-header">
		<h4 class="widget-title">Form Kategori Karya</h4>
...
<div class="row">
<div class="col-xs-12">
<form id="form-add" class="form-horizontal" action="<?= site_url('C_produk/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data">
	<input type="hidden" name="id_produk">
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Karya </label>
		<div class="col-sm-10">
			<input type="text" id="nama_produk" name="nama_produk" placeholder= "Nama Karya" class="col-xs-10 col-sm-5" />
			<span class="help-block"></span>
		</div>
	</div>
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi Karya</label>
		<div class="col-sm-6">
			<textarea class="form-control" id="deskripsi_produk1" name="deskripsi_produk1" placeholder="Deskripsi Karya" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
			<span class="help-block"></span>
		</div>
	</div>
...
<div class="tabbable">
	...
	<form action="#" id="form" name="form" class="form-horizontal" enctype="multipart/form-data">
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi Karya</label>
			<div class="col-sm-6">
				<textarea class="form-control" id="deskripsi_produk" name="deskripsi_produk1" placeholder="Deskripsi Karya" class="col-xs-10 col-sm-5"></textarea>
				<span class="help-block"></span>
			</div><br /><br /><br /><br />
			<div class="col-md-offset-2 col-md-9">
	...
	<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('C_produk/upload')?>" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="id_produk"/> 
		<div class="form-body">
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('C_produk')?>";
	var table;
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('C_produk/ajax_list')?>",
            "type": "POST"
        },
	...
	function edit(id) {
			...
			$.ajax({
				...
				success: function(result) {  
					var img = '<?= base_url(); ?>assets/images/'+result.file_foto_produk;
					...
					tinymce.editors[1].setContent(result.deskripsi_produk);
	...
	function hapus(id) {
		if (confirm('Are you sure delete this data?')) {
			$.ajax ({
				url : "<?php echo site_url('C_produk/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data) {
					setTimeout(function(){
