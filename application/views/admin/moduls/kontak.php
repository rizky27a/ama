...
<div class="form-group">
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nomor Whatsapp </label>

		<div class="col-sm-10">

			<input type="number" id="nomor_wa" name="nomor_wa" placeholder="Contoh : 083812345678" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> akun Instagram </label>

		<div class="col-sm-10">

			<input type="text" id="akun_ig" name="akun_ig" placeholder="Contoh : instagram.com/akun_anda/" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> akun Facebook </label>

		<div class="col-sm-10">

			<input type="text" id="akun_fb" name="akun_fb" placeholder="Contoh : facebook.com/akun_anda?ref=bookmarks" class="col-xs-10 col-sm-5" />
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="modal-title"><h5>Pilih Lokasi</h5></div>
	...
	function edit() {
			...
			$.ajax({
				...
				success: function(result) {  
					...
					$('[name="akun_ig"]').val(result.akun_ig);

					$('[name="akun_fb"]').val(result.akun_fb);

					$('[name="nomor_wa"]').val(result.nomor_wa);
