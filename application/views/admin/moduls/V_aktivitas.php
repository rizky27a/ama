...
<?php $title = "<i class='fa fa-file-image-o'></i>&nbsp;Aktivitas"; ?>
...
<div class="widget-box">
<div class="widget-header">
		<h4 class="widget-title">Form Kategori Aktivitas</h4>
...
<div class="row">
<div class="col-xs-12">
<form id="form-add" class="form-horizontal" action="<?= site_url('C_aktivitas/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data">
	<input type="hidden" name="id_aktivitas">
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Aktivitas </label>
		<div class="col-sm-10">
			<input type="text" id="nama_aktivitas" name="nama_aktivitas" placeholder= "Nama Aktivitas" class="col-xs-10 col-sm-5" />
			<span class="help-block"></span>
		</div>
	</div>
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi Aktivitas</label>
		<div class="col-sm-6">
			<textarea class="form-control" id="deskripsi_aktivitas1" name="deskripsi_aktivitas" placeholder="Deskripsi Aktivitas" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
			<span class="help-block"></span>
		</div>
	</div>
...
<div class="tabbable">
	...
	<form action="#" id="form" name="form" class="form-horizontal" enctype="multipart/form-data">
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi Aktivitas</label>
			<div class="col-sm-6">
				<textarea class="form-control" id="deskripsi_aktivitas" name="deskripsi_aktivitas" placeholder="Deskripsi Aktivitas" class="col-xs-10 col-sm-5"></textarea>
				<span class="help-block"></span>
			</div><br /><br /><br /><br />
			<div class="col-md-offset-2 col-md-9">
	...
	<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('C_aktivitas/upload')?>" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="id_aktivitas"/> 
		<div class="form-body">
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('C_aktivitas')?>";
	var table;
	...
	function save() {
		var url;
		url = "<?= site_url()?>C_aktivitas/update/";
		tinyMCE.triggerSave();
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('C_aktivitas/ajax_list')?>",
            "type": "POST"
        },
	...
	function edit(id) {
			...
			$.ajax({
				...
				success: function(result) {  
					var img = '<?= base_url(); ?>assets/images/'+result.file_foto_aktivitas;
					$('[name="id_aktivitas"]').val(result.id_aktivitas);
					$('[name="nama_aktivitas"]').val(result.nama_aktivitas);
					$('#preview-upload').attr('src', img);
					//$('[name="deskripsi_produk1"]').val(result.deskripsi_produk);
					tinymce.editors[1].setContent(result.deskripsi_aktivitas);
	...
	function hapus(id) {
		if (confirm('Are you sure delete this data?')) {
			$.ajax ({
				url : "<?php echo site_url('C_aktivitas/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data) {
					setTimeout(function(){
