...
<div class="tabbable">
	...
	<div class="tab-content">
		...
		<div id="messages" class="tab-pane fade">
			<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('Gallery/upload_det')?>" method="POST" enctype="multipart/form-data">
				<input type="hidden" name="id_gallery"/> 
				<div class="form-body">
					<div class="form-group" >
...
<script type="text/javascript">
	...
	function save() {
		var url;
		url = "<?= site_url()?>Gallery/update_foto/";
		tinyMCE.triggerSave();
