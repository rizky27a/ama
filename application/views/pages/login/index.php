...
<!--[if gt IE 9]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Asosiasi Manajemen Indonesia</title>
    ...
    <div class="md-card" id="login_card">
        <div class="md-card-content large-padding" id="login_form">
            <h2 class="heading_a uk-margin-medium-bottom uk-text-center">Login Member</h2>
            <div id="message"></div>
            <form action="<?= site_url('login/getlogin') ?>" method="post">
			<div class="alert alert-danger" role='alert' id="pesan" hidden>
                ...
                <div class="uk-margin-medium-top">
					<button type="submit" id="login" class="md-btn md-btn-primary md-btn-block md-btn-large" value="Login">
                </div>
            </form>
        </div>
    </div>
